...
import { rxnormService, RxNormService } from "./rxnormService";
import {
...
import { createLogger, DrugNotFoundError, RxCUINotFoundError } from "@core-guardrails";
import { BUSINESS_RULES } from "@core-config";
...
export class DrugNormalizer {
  ...
  constructor(service?: RxNormService) {
    this.rxnormService = service ?? rxnormService;
  }
